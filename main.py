...
class AdScriptInput(BaseModel):
    ...
    tone: Literal['hook', 'problem', 'solution', 'social_proof', 'urgency', 'transformation', 'curiosity', 'authority']
    format: Literal['ugc_style', 'testimonial', 'demo_style', 'influencer_style', 'news_style', 'comparison']
